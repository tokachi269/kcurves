...
namespace Assets
{
    public class NewTestScript
    {
        ...
        public void PathCalculatingTest()
        {
            ...
            System.Type myClass = typeof(Path.Path);
            UnityEngine.Assertions.Assert.IsNotNull(myClass);
            var Property = myClass.GetProperty("Beziers.SegmentCount", BindingFlags.NonPublic | BindingFlags.Static);
            Assert.AreEqual(Property.SegmentCount, 6);
            Assert.AreEqual(Property.Beziers.Points.Length, 13);
