...
namespace Assets
{
	public class ControlPoint
	{
		...
		public EasingMode easingMode = EasingMode.Auto;

		public ControlPoint(Vector3 position, Quaternion rotation, float fov, bool isLookAt, !EasingMode EasingMode.Auto)
		{
