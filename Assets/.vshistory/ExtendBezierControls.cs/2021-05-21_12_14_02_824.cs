...
namespace Assets
{
    public class ExtendBezierControls : BezierControls
    {
        ...
        {
            Vector3[] plots = CalcPlots(Points.Length, ArcLengthWithTStep, isLoop);
        ...
        public Vector3[] CalcPlots(int count,int stepPerSegment, bool isLoop)
        {
            ...
            if (SegmentCount < 3)
                ...
                plots = new Vector3[(isLoop || SegmentCount != count ? SegmentCount : (SegmentCount - 2)) * stepPerSegment + 1];
