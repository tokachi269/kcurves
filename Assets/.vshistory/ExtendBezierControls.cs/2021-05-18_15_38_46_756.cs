...
namespace Assets
{
    public class ExtendBezierControls : BezierControls
    {
        ...
        public ExtendBezierControls( Vector3[] points, bool isLoop) : base((points.Length - 2) /2+2, isLoop)
        {
            this.Points = points;
            Lengths = new float[SegmentCount <= 1 ? 1 : SegmentCount - 2, ArcLengthWithTStep];
