    ...
    public class ExtendBezierControls : BezierControls
    {
        ...
        public Vector3[] CalcPlots(int count,int stepPerSegment, bool isLoop)
        {
            ...
            if (Points.Length < 3)
                ...
                plots = new Vector3[(isLoop ? Points.Length : (Points.Length - 2)) * stepPerSegment + 1];
            
            int segCnt = isLoop || SegmentCount < 3 ? SegmentCount : SegmentCount;
            ...
            plots[plots.Length] = BezierUtil.Position(this[last, 0], this[last, 1], this[last, 2], 1);
            return plots;
        }
