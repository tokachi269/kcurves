...
namespace Assets
{
    public class ExtendBezierControls : BezierControls
    {
        ...
        public ExtendBezierControls(ushort n, bool isLoop) : base(n, isLoop)
        {
            Lengths = new float[SegmentCount <= 1 ? 1 : SegmentCount-2, ArcLengthWithTStep];
            IsCalcArcLengthWithT = false;
        }

        public ExtendBezierControls(ushort n, Vector3[] points, bool isLoop) : base(n, isLoop)
        {
            this.Points = points;
        ...
        public void CalcArcLengthWithT(int count ,bool isLoop)
        {
            ...
            for (ushort i = 0; i < Lengths.GetLength(0); i++)
            {
        ...
        public Vector3[] CalcPlots(int count, ushort stepPerSegment, bool isLoop)
        {
