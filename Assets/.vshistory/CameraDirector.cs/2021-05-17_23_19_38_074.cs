    ...
    public class CameraDirector : MonoBehaviour
    {
        ...
        public void renderObject()
        {
            if (!(path is null))
            {
                ...
                bezierObject[bezierObject.Count] = GameObject.CreatePrimitive(PrimitiveType.Cube);
                bezierObject[bezierObject.Count].transform.position = path.extendBezierControls.Points[path.extendBezierControls.Points.Length-1];

                bezierObject[bezierObject.Count].transform.localScale = new Vector3(0.2f, 0.2f, 0.2f);
                bezierObject[bezierObject.Count].transform.parent = this.transform;
                bezierObject[bezierObject.Count].GetComponent<Renderer>().material.color = Color.red;
