        ...
        void Update()
        {
            ...
            if (isStart)
            {
                ...
                if (path.Knots.Count > 1 && moveCameraCube != null)
                {
                    ...
                    Debug.Log(Convert.ToString((byte)EasingMode.None | ((byte)EasingMode.Auto << 1), 2));
                    Debug.Log(Convert.ToString(((byte)EasingMode.EaseInOut | ((byte)EasingMode.None << 1)), 2));
                    Debug.Log(Convert.ToString((byte)EasingMode.EaseInOutBack | ((byte)EasingMode.None << 1), 2));
