...
namespace Assets
{
    public class CameraDirector : MonoBehaviour
    {
        ...
        {
            int k = 1;
            Debug.Log("C:\Users\user\AppData\Local\Colossal Order\Cities_Skylines\Addons\Mods\Kamine_TimetableMod\Line1_Timetable" + k.ToString() + ".txt");
            StreamReader streamReader = new StreamReader(@"C:\Users\user\AppData\Local\Colossal Order\Cities_Skylines\Addons\Mods\Kamine_TimetableMod\Line1_Timetable" + k.ToString() + ".txt", Encoding.GetEncoding("UTF-8"));
