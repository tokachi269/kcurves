        ...
        void Update()
        {
            ...
            if (isStart)
            {
                ...
                if (path.Knots.Count > 1 && moveCameraCube != null)
                {
                    ...
                    Debug.Log("None,Auto" +  ((byte)EasingMode.None | ((byte)EasingMode.Auto << 1)).ToString());
                    Debug.Log("EaseInOut,None" + ((byte)EasingMode.EaseInOut | ((byte)EasingMode.None << 1)).ToString());
                    Debug.Log("EaseInOutBack,None" + ((byte)EasingMode.EaseInOutBack | ((byte)EasingMode.None << 1)).ToString());
