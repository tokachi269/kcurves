        ...
        void Update()
        {
            ...
            if (isStart)
            {
                ...
                if (path.Knots.Count > 1 && moveCameraCube != null)
                {
                    ...
                    Debug.Log("None,Auto" + Convert.ToString((byte)EasingMode.None | ((byte)EasingMode.Auto << 1), 2));
                    Debug.Log("EaseInOut,None" + Convert.ToString((byte)EasingMode.EaseInOut | ((byte)EasingMode.None << 1), 2));
                    Debug.Log("EaseInOutBack,None" + Convert.ToString((byte)EasingMode.EaseInOutBack | ((byte)EasingMode.None << 1), 2));

                    Convert.ToString(((byte)EasingMode.None | ((byte)EasingMode.Auto << 1)), 2)

                    Debug.Log("None,Auto" +  ((byte)EasingMode.None | ((byte)EasingMode.Auto << 1)));
                    Debug.Log("EaseInOut,None" + ((byte)EasingMode.EaseInOut | ((byte)EasingMode.None << 1)));
                    Debug.Log("EaseInOutBack,None" + ((byte)EasingMode.EaseInOutBack | ((byte)EasingMode.None << 1)));
