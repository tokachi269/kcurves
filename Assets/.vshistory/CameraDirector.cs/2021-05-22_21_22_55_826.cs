            ...
            if (isStart)
            {
                ...
                if (path.Knots.Count > 1 && moveCameraCube != null)
                {
                    ...
                    if (t <= path.Beziers.SegmentCount)
                    {
                        ...
                        Quaternion rot= path.CalcRotation(bezierIndex, inputL);
