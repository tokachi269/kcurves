        ...
        void Update()
        {
            ...
            if (isStart)
            {
                ...
                if (path.Knots.Count > 1 && moveCameraCube != null)
                {
                    ...
                    Debug.Log((byte)EasingMode.None | ((byte)EasingMode.Auto << 1));
                    Debug.Log((byte)EasingMode.EaseInOut | ((byte)EasingMode.None << 1));
                    Debug.Log((byte)EasingMode.EaseInOutBack | ((byte)EasingMode.None << 1));
