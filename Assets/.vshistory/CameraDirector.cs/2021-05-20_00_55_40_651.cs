...
namespace Assets
{
    public class CameraDirector : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            path.AddKnot(new Vector3(2, 2, 2), new Quaternion(0, 0, 0, 1), 60, true);
            path.AddKnot(new Vector3(3, 3, 3), new Quaternion(0, 0, 0, 1), 60, false);
            path.AddKnot(new Vector3(4, 4, 4), new Quaternion(0, 0, 0, 1), 60, false);
