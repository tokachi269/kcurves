        ...
        void Update()
        {
            ...
            if (isStart)
            {
                ...
                if (path.Knots.Count > 1 && moveCameraCube != null)
                {
                    ...
                    //GameObject.Find("Main Camera").transform.position = path.CalcPosition(isLoop, t);
                    //GameObject.Find("Main Camera").transform.rotation = path.CalcRotation(segIndex, inputL);
