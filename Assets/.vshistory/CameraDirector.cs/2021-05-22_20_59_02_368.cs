        ...
        void Update()
        {
            ...
            if (isStart)
            {
                ...
                if (path.Knots.Count > 1 && moveCameraCube != null)
                {
                    ...
                    path.GetBeforeAndBehindKnot(segIndex, out knotIndex, out nextKnotIndex);

                    EasingMode x = (EasingMode)((byte)path.Knots[knotIndex].easingMode | ((byte)path.Knots[nextKnotIndex].easingMode << 1));
                    ...
                    switch (x)
                    {
                        case EasingMode.NoneNone: None();
                        case EasingMode.NoneAuto: EaseOut();
                        case EasingMode.NoneEaseInOut: EaseOut();
                        case EasingMode.NoneEaseInOutBack: EaseOutBack();
                        case EasingMode.AutoNone: EaseIn();
                        case EasingMode.AutoAuto: EaseInOut();
                        case EasingMode.AutoEaseInOut: EaseInOut();
                        case EasingMode.AutoEaseInOutBack: EaseInOutBack();
                        case EasingMode.EaseInOutNone: EaseIn();
                        case EasingMode.EaseInOutAuto: EaseInOut();
                        case EasingMode.EaseInOutEaseInOut: EaseInOut();
                        case EasingMode.EaseInOutEaseInOutBack: EaseInOut();
                        case EasingMode.EaseInOutBackNone: EaseInBack();
                        case EasingMode.EaseInOutBackAuto: EaseInOutBack();
                        case EasingMode.EaseInOutBackEaseInOut: EaseInOut();
                        case EasingMode.EaseInOutBackEaseInOutBack: EaseInOutBack();
