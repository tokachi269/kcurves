...
namespace Assets
{
    ...
    {
        //始値と終値の差分の10％分となる値
        private static float EasingBack = 1.70158f;
        ...
        {
            float c3 = EasingBack + 1;

            return (float)(1 + c3 * Math.Pow(t - 1, 3) + EasingBack * Math.Pow(t - 1, 2));
        }
        ...
        private static float EaseInBackSin(float t)
        {
            ...
            return c3 * t * t * t - EasingBack * t * t;
        }
    }
}
