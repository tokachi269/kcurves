...
namespace Assets
{
    ...
    class Easing
    {
        ...
        public static float GetEasing(EasingMode mode, float Progress, float KnotBetweenRange)
        {
            float num;
            float num2 = Progress / KnotBetweenRange;
            switch (mode)
            {
