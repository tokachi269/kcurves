...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        public void MoveCamera()
        {
            ...
            else if (bezierIndex!=0 && ProgressLength < Beziers.Length(bezierIndex - 1) + Beziers.Length(bezierIndex)) bezierIndex++;


            float easing = Easing.GetEasing(mode, (bezierIndex % 2 == 0 ? ProgressLength - Beziers.Length(2 * knotIndex - 1) : ProgressLength) / KnotBetweenRange);
            Debug.Log(easing);
