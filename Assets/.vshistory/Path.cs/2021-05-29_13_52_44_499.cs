    ...
    public class Path : MonoBehaviour
    {
        ...
        public void MoveCamera()
        {
            //Debug.Log("TotalLength:" + path.Beziers.TotalLength);
                ...
                t = Beziers.GetT(bezierIndex, out nextBezierIndex, ref inputL);
        ...
        public Quaternion CalcRotation(int segIndex, float inputL)
        {
            ...
            {
                for (ushort i = segIndex - 1; i <= segIndex + 1; i++)
                {
        ...
        public Vector3[] DividePoints(bool isLoop, out int dividedSegmentCount)
        {
            ...
            ushort segCnt = isLoop || Beziers.SegmentCount < 3 ? Beziers.SegmentCount : Beziers.SegmentCount - 2;
