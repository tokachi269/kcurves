...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        public void MoveCamera()
        {
            ...
            mode = (EasingMode)((byte)_knots[_knotIndex].easingMode | ((byte)_knots[_knotIndex + 1].easingMode << 1));
            Debug.Log(mode);
            ...
            float easing = Easing.GetEasing(mode, (_bezierIndex != 0 && _bezierIndex % 2 == 0 ? _ProgressLength - _beziers.Length(2 * _knotIndex - 1) : _ProgressLength) / KnotBetweenRange);
            Debug.Log(easing);
