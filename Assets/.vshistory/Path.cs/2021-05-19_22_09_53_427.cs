...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        {                                                                           //5       
            dividedSegmentCount = (extendBezierControls.SegmentCount - 2 ) * 2 + 2; //8
            Vector3[] dividedPoints = new Vector3[dividedSegmentCount * 2 + 1]; //17
            ...
            for (int i = 0; i < extendBezierControls.SegmentCount - 1; i++)
            {
