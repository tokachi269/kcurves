...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        public void MoveCamera()
        {
            ...
            if (knotIndex != 0)
            {
                progressre -= Beziers.Length(0);
                for (int k = 0; k < (knotIndex - 1) *2; k++)
                {
            ...
            if (progressre > Beziers.Length(bezierIndex))
            {
                if (bezierIndex % 2 == 1)
                {
                    bezierIndex++;
                    Debug.Log("bezierIndex++");
                }  else if (bezierIndex == 0){
                    bezierIndex++;
                    progressre -= Beziers.Length(bezierIndex - 1) + Beziers.Length(bezierIndex);
                    Debug.Log("knotIndex++");
                }else if (bezierIndex % 2 == 0 && progressre > Beziers.Length(bezierIndex - 1) + Beziers.Length(bezierIndex))
                {
                    bezierIndex++;
                    progressre -= Beziers.Length(bezierIndex - 1) + Beziers.Length(bezierIndex);
                    Debug.Log("knotIndex++");
            ...
            if (bezierIndex % 2 == 0 && bezierIndex != 0)
            {
