...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        {                                                                           //5       
            ...
            for (int i = 1; i < extendBezierControls.SegmentCount-2; i++)
            {
                Vector3[] result = BezierUtil.Divide(extendBezierControls[i, 0], extendBezierControls[i, 1], extendBezierControls[i, 2], (float)extendBezierControls.Ts[i]);
