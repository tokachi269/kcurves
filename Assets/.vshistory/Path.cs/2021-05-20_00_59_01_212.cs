...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        {                                                                                 
            dividedSegmentCount = (extendBezierControls.SegmentCount - 2 ) * 2 + 2  ;
            ...
            dividedPoints[dividedSegmentCount - 2] = extendBezierControls.Points[extendBezierControls.Points.Length - 2];
        ...
        public Vector3[] Output(int step, bool isLoop)
        {
            ...
            if (extendBezierControls.SegmentCount > 3 || (extendBezierControls.SegmentCount != (Knots.Count < 3 ? 1 : Knots.Count)))
            {
                ...
                extendBezierControls = new ExtendBezierControls(segment, divVec, isLoop);
            }
