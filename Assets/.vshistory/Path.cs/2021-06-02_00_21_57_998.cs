...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        public void MoveCamera()
        {
            ...
            if (bezierIndex % 2 == 1 || (bezierIndex == 0 && ProgressLength > Beziers.Length(bezierIndex)))
            {
            ...
            else if (bezierIndex == 0 && ProgressLength > Beziers.Length(bezierIndex)) 
            {
                bezierIndex++;
            ...
            float d = (bezierIndex != 0 && bezierIndex % 2 == 0 ? easing - Beziers.Length(2 * knotIndex - 1) : easing);
            t = Beziers.GetT(bezierIndex, d * KnotBetweenRange);
