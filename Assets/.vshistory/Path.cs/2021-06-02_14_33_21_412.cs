...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        public void MoveCamera()
        {
            ...
            {
                if (bezierIndex == 0 || ProgressLength > Beziers.Length(bezierIndex - 1) + Beziers.Length(bezierIndex))
                {
                    bezierIndex++;
                    ProgressLength -= Beziers.Length(0);
                    Debug.Log("knotIndex++");
                }
            ...
            {
                ProgressLength -= Beziers.Length(2 * knotIndex - 1);
            }
