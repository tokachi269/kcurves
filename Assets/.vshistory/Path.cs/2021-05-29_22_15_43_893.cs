...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        public void MoveCamera()
        {
            ...
            knotIndex = (ushort)(bezierIndex % 2 == 0 ? bezierIndex + 1 / 2 : bezierIndex / 2);
            ...
            if (bezierIndex % 2 == 1)
            {
                if (ProgressLength < Beziers.Lengths[bezierIndex, Beziers.ArcLengthWithTStep - 1]) bezierIndex++;
            }
            else
            {
                if (bezierIndex!=0 && ProgressLength < Beziers.Lengths[bezierIndex - 1, Beziers.ArcLengthWithTStep - 1] + Beziers.Lengths[bezierIndex, Beziers.ArcLengthWithTStep - 1]) bezierIndex++;
            }


            float easing = Easing.GetEasing(mode, (bezierIndex % 2 == 0 ? ProgressLength - Beziers.Lengths[2 * knotIndex - 1, Beziers.ArcLengthWithTStep - 1] : ProgressLength) / KnotBetweenRange);
            Debug.Log(easing);
