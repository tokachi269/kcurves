    ...
    public class Path : MonoBehaviour
    {
        ...
        public Quaternion CalcRotation(int segIndex, float inputL)
        {
            ...
            if (!Quaternion.Equals(Knots[knotIndex].rotation, Knots[knotNextIndex].rotation))
            {
                ...
                rotation = Vector3.Lerp(Knots[knotIndex].rotation.eulerAngles, new Vector3(ClosestAngle(Knots[knotIndex].rotation.eulerAngles,out Knots[knotNextIndex].rotation.eulerAngles)), t);
            }
            else
            {
        ...
        public static void ClosestAngle(Vector3 basePoint, out Vector3 point)
        {
