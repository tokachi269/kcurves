...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        public Quaternion CalcRotation(int segIndex, float inputL)
        {
            ...
            Before andAfterKnotAcquisition(segIndex, out knotIndex, out nextKnotIndex);
            float t,sum = 0;
        ...
        public void Before andAfterKnotAcquisition(int segIndex ,out int knotIndex,out int nextKnotIndex)
        {
            if (segIndex == 0)
            {
                knotIndex = 0;
