...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        public void MoveCamera()
        {
            ...
            if (num1 >= Beziers.Length(bezierIndex))
            {
                if (bezierIndex % 2 == 1)
                {
                    bezierIndex++;
                    ...
                    bezierIndex++;
                    num1 -= Beziers.Length(bezierIndex - 1) + Beziers.Length(bezierIndex);
                    Debug.Log("knotIndex++");
                }else if (num1 > Beziers.Length(bezierIndex - 1) + Beziers.Length(bezierIndex))
                {
                    bezierIndex++;
                    num1 -= Beziers.Length(knotIndex - 1) + Beziers.Length(knotIndex);
                    Debug.Log("knotIndex++");
                }
            ...
            {
                num1 -= Beziers.Length(2 * knotIndex - 1);
            }

            num1 /= KnotBetweenRange;

            float easing = Easing.GetEasing(mode, num1);
            Debug.Log("easing:"+easing);
            easing *= KnotBetweenRange;

            if (bezierIndex % 2 == 0 && bezierIndex != 0)
            {
                easing = (easing - Beziers.Length(2 * knotIndex - 1));
            }
