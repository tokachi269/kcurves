...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        {                                                                           //5       
            dividedSegmentCount = (extendBezierControls.SegmentCount - 2 ) * 2 + 1; //7
            Vector3[] dividedPoints = new Vector3[dividedSegmentCount * 2 + 1]; //15
            ...
            for (int i = 0; i < extendBezierControls.SegmentCount - 2; i++)
            {
                ...
                for (int j = 0; j <= 3; j++)
                {
                    dividedPoints[4 * i + j+1] = result[j];
                }
