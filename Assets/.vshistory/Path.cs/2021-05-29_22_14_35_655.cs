...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        public void MoveCamera()
        {
            ...
            if (bezierIndex % 2 == 1)
            {
                if (ProgressLength < Beziers.Lengths[bezierIndex, Beziers.ArcLengthWithTStep - 1])
                {
                    bezierIndex++;
                }
            }
            ...
            {
                if (bezierIndex!=0 && ProgressLength < Beziers.Lengths[bezierIndex - 1, Beziers.ArcLengthWithTStep - 1] + Beziers.Lengths[bezierIndex, Beziers.ArcLengthWithTStep - 1])
                {
                    bezierIndex++;
                }
            }
