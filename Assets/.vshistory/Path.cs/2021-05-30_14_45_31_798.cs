...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        public void MoveCamera()
        {
            ...
            Debug.Log(Knots[knotIndex].easingMode);
            Debug.Log(Knots[knotIndex+1].easingMode);
            Debug.Log(mode);
            ...
            t = Beziers.GetT(bezierIndex, (bezierIndex != 0 && bezierIndex % 2 == 0 ? easing - Beziers.Length(2 * knotIndex - 1) : easing) * KnotBetweenRange);
