...
namespace Assets
{
    public class Path : MonoBehaviour
    {
        ...
        public Quaternion CalcRotation(int segIndex, float inputL)
        {
            ...
            BeforeWithAfterKnotAcquisition(segIndex, out knotIndex, out nextKnotIndex);
            float t,sum = 0;
        ...
        public void BeforeWithAfterKnotAcquisition(int segIndex ,out int knotIndex,out int nextKnotIndex)
        {
            if (segIndex == 0)
            {
                knotIndex = 0;
