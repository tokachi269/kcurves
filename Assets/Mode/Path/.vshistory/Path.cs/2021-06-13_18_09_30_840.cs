    ...
    public class Path : BaseCameraMode, ICameraMode
    {
        ...
        public IEnumerator Play()
        {
            ...
            for (float currentTime= 0; ;)
            {
                ...
                float easing = Easing.GetEasing(mode, BezierProgressLength/ KnotBetweenRange);

                //Debug.Log("easing:"+ easing);

                float t = Beziers.GetT(bezierIndex, bezierIndex != 0 && bezierIndex % 2 == 0 ? easing - Beziers.Length(bezierIndex-1) : easing);
                ...
                BezierProgressLength += maxSpeed * dt;
                currentTime += dt;
                yield return null;
            }
        }
