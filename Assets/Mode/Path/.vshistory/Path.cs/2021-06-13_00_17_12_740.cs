    ...
    public class Path : BaseCameraMode, ICameraMode
    {
        ...
        public IEnumerator Play()
        {
            ...
            for (float currentTime= 0; ;)
            {
                ...
                float t = Beziers.GetT(bezierIndex, bezierIndex != 0 && bezierIndex % 2 == 0 ? easing - Beziers.Length(2 * knotIndex - 1) : easing);
                ...
                if (t <= Beziers.SegmentCount)
                {
                    ...
                    Quaternion rot = CalcRotation(knotIndex, easing/KnotBetweenRange);
